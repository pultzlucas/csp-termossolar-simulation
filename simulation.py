...
while running:
    ...
    # light_surface.fill(background_color)

    line_width = 2
    for point in range(int(2000 / line_width)):
        pygame.draw.line(light_surface, '#F7C50133', sun_simulation.center, ((SCREEN_WIDTH / 2 - (2000 / 2)) + point * line_width, SCREEN_HEIGHT), line_width)
