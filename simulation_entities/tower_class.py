...
class TowerSimulation:
    def __init__(self, screen: pygame.Surface) -> None:
        ...
        self.receptor_pos = (self.center_x_pos, self.tower_height - ((self.receptor_height + 26) / 2))
    ...
    def draw(self, screen: pygame.Surface):
        ...
        pygame.draw.rect(screen, 'black', (50 + (self.tower_width / 2) - (self.receptor_width / 2), self.tower_height - self.receptor_height, self.receptor_width, self.receptor_height))